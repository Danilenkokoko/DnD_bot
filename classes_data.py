...
CLASSES_DATA: Dict[str, Dict[str, Any]] = {
    "Артефактор": {
        ...
        "description": "Мастера раскрытия магии в обычных вещах, изобретатели — величайшие выдумщики. Они видят магию как сложную систему, которую нужно расшифровывать и контролировать. Направляя волшебную силу инструментами, изобретатели создают магические предметы. Творя заклинание, изобретатель может использовать инструменты алхимика для создания мощного зелья, инструменты каллиграфа для написания знака силы на доспехах союзника или инструменты ремесленника для создания временного предмета.",
        "features": {
    ...
    "Варвар": {
        ...
        "spellcasting": False,
        "description": "Несмотря на разнообразие, всех варваров объединяет одно — их ярость. Необузданный, неугасимый и бездумный гнев. Не просто эмоция, их ярость как свирепость загнанного в угол хищника, как безжалостный удар урагана, как штормовые валы океана.",
        "features": {
    ...
    "Воин": {
        ...
        "spellcasting": False,
        "description": "Все эти герои — воины. Представители, возможно, самого разнообразного класса в мире D&D. Странствующие рыцари, военачальники-завоеватели, королевские чемпионы, элитная пехота, бронированные наёмники и короли разбоя — будучи воинами, все они мастерски владеют оружием, доспехами, и приёмами ведения боя. А ещё они хорошо знакомы со смертью — они несут её сами, и часто смотрят в её холодные глаза.",
        "features": {
...
# Словарь с путями к картинкам классов
CLASS_IMAGES = {
