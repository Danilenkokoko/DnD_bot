# repositories/class_repository.py (полный исправленный файл с десериализацией skills)
"""
...
class ClassRepository(BaseRepository):
    ...
    def get_skills_list(self, class_name: str) -> List[str]:
    ...
    def get_skill_choices_count(self, class_name: str) -> int:
        """Возвращает количество навыков, которые должен выбрать игрок"""
        class_data = self.get_by_name(class_name)
        return class_data.get('skill_choices', 2) if class_data else 2
