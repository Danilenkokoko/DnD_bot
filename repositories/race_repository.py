...
class RaceRepository(BaseRepository):
    ...
    # Расовые бонусы к характеристикам удалены согласно правилам D&D 5.5e (2024)
    # В новой редакции расы (виды) не дают бонусов к характеристикам.
    # Методы get_ability_bonuses() больше не предоставляются.
