...
INVOCATIONS = [
    {"name": "Договор клинка", "level": 1,
     "effect": "Вы создаёте магическое оружие или связываете с собой существующее. Можете использовать Харизму для бросков атаки и урона этим оружием.",
     "requires_pact_boon": True, "pact_boon_type": "Blade"},
    {"name": "Договор цепи", "level": 1,
     "effect": "Вы учите заклинание «Обретение фамильяра» с расширенными формами (бес/квазит/спрайт/псевдодракон).",
     "requires_pact_boon": True, "pact_boon_type": "Chain"},
    {"name": "Договор гримуара", "level": 1,
     "effect": "Вы получаете 3 заговора из любых списков и 2 ритуала 1 уровня.",
     "requires_pact_boon": True, "pact_boon_type": "Tome"},
